...
class Bow_non_offhand_Util:
    ...
    def get_display_initialize(display_data, namespace=None, model_path="", model_name="bow"):
        ...
        # Lấy bow2 display data
        bow2_data = Bow_non_offhand_Util.get_bow2_display_data(namespace, model_path, model_name)
        
        # Nếu không tìm thấy bow_2 tương ứng, sử dụng firstperson_righthand hiện tại
        if bow2_data:
            bow_pull_trans = bow2_data['translation']
            bow_pull_rot = bow2_data['rotation']
            bow_pull_scale = bow2_data['scale']
        else:
            bow_pull_trans = fp_rh_trans
            bow_pull_rot = fp_rh_rot
            bow_pull_scale = fp_rh_scale
    ...
    def write(file, gmdl, textures, geometry, mdefault, menchanted, animations, animate, pre_animation, display_data=None):
        ...
        initialize = Bow_non_offhand_Util.get_display_initialize(display_data, namespace, model_path, model_name)
    ...
    def merge_bow_models():
        ...
        # Find all bow model directories
